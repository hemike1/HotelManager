<div class="d-flex flex-column flex-shrink-0 bg-light sidebar">
    <a href="/korondi/home" class="d-block p-3 link-dark text-decoration-none border-bottom border-5" title="Főoldal" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Főoldal">
        <image class="bi" width="38" height="40" src="Assets/images/HotelLogo.png" title="Logo" alt="Logo"></image>
    </a>
